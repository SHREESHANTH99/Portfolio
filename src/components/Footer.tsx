 ...
 * Follows the engineering-driven aesthetic.
 */
...
export default function Footer() {
    ...
    return (
        ...
        bg-[hsl(var(--color-bg-secondary))] pt-12"
            role="contentinfo"
        >
            <div className="container-custom py-12 md:py-16">
                <div className="grid gap-8 md:grid-cols-3">
                    ...
                    <div>
                        <Link
                            href="/"
                            className="inline-block font-semibold text-lg tracking-tight
                hover:text-[hsl(var(--color-accent-primary))] transition-colors"
                        >
                            {siteConfig.name.split(" ")[0]}
                            <span className="text-[hsl(var(--color-accent-primary))]">.</span>
                        </Link>
                        <p className="mt-3 text-sm text-[hsl(var(--color-text-secondary))] max-w-xs">
                            {siteConfig.role}
                        </p>
                    </div>
              ...
              text-[hsl(var(--color-text-tertiary))]">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a
                                ...
                                className="p-2.5 rounded-lg bg-[hsl(var(--color-bg-tertiary))]
